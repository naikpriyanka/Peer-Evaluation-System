...
/*
 * Class for Starting Window of Peer UserInitialInput System where the user is asked for number of team members
 * and if scores have been previously entered.
 * */
public class PeerAndSelfEvaluation {
    ...
    public static void main(String args[]) {
        PeerAndSelfEvaluation peerEvaluation = new PeerAndSelfEvaluation();
    ...
    protected void addElements() {
        ...
        frame = new JFrame("Peer UserInitialInput System");
    ...
    */
    private class SubmitButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            UserInitialInput eval = new UserInitialInput((int) teamMembersCombo.getSelectedItem(), previousScoresEntered);
            eval.start();
        }
    }
}
